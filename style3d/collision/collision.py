...
class Collision:
    def __init__(self, model: Model):
        ...
        """
        self.model = model
        self.radius = 4e-3  # Contact radius
        self.stiff_vf = 0.1  # Stiffness coefficient for vertex-face (VF) collision constraints
        self.stiff_ee = 0.02  # Stiffness coefficient for edge-edge (EE) collision constraints
        self.stiff_ef = 0.20  # Stiffness coefficient for edge-face (EF) collision constraints
