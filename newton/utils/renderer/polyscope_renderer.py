...
class PolyscopeRenderer:
    def __init__(
        ...
        # Statistics
        self._body_count = model.body_count
        self._triangle_count = model.tri_count
        self._tetrahedra_count = model.tet_count
    ...
    def _update_gui(self):
        ...
        psim.Text(f" - Body Count: {self._body_count}")
        psim.Text(f" - Particle Count: {self._particle_count}")
        psim.Text(f" - Triangle Count: {self._triangle_count}")
        psim.Text(f" - Tetrahedra Count: {self._tetrahedra_count}")
